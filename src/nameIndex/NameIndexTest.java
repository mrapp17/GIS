...
////		for(int i = 0; i < 5; ++i){
////			for(int j = 0; j < 5; ++j) {
////				assertNotEquals(-1, testIndex.indexName(testKeys1[i], testKeys2[j], numIndex++));
////			}
////		}
//	}
//
...
//		for(int i = 0; i < 5; ++i){
//			for(int j = 0; j < 5; ++j) {
//				assertNotEquals(-1, testIndex.indexName(testKeys1[i], testKeys2[j], testValues[numIndex++]));
//			}
//		}
//		
//		numIndex = 0;
